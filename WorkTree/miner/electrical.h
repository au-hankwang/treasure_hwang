...
const float ir_resistance = 0.00035;  // Ohm/chip
const float air_conduction = .017;  // C/W
//const float hashmul = 202 * 4 / 1.0 / 1.0e6;
const float hashmul = 254 * 4 / 3.0 / 1.0e6;
const float ref_frequency = 1350;	   // Mhz
const float ref_efficiency = 22.75;     // J/TH
const float ref_voltage = .290;	       // Volts
const float ref_temperature = 85;	   // Celcius
const float ref_leakage_percentage = .29;	       // 0-1.0
const float ref_leakage = hashmul * ref_efficiency * ref_frequency * ref_leakage_percentage / ref_voltage;
const float leakage_half = 23.0;	   // Celcius
const float ref_vt = .18;	           // Volts
const float vt_temp = -0.00045;         // V/C
const float perf_half_up = 350;	       // Celcius
const float perf_half_down = 235;	   // Celcius
