...
void chiptype::Performance(float &pbest, float &p100, float& p140, float& p180)
   ...
   e = Minimum(1370, fan_power / 396, v, t);


   for (f = 400; f <= 1500; f += 25) {
   ...
   pbest = min_e;
   printf("Best efficiency %4.1fJ/TH %3.0fTH %.0fC %.1fmV\n", min_e, min_f * .134112 * 0.98, t, v * 1000.0);
   p100 = Minimum(750, fan_power / 396, v, t);
   printf("Best efficiency %4.1fJ/TH %3.0fTH %.0fC %.1fmV\n", e, 750 * .134112 * 0.98, t, v * 1000.0);
   p140 = Minimum(1065, fan_power / 396, v, t);
   printf("Best efficiency %4.1fJ/TH %3.0fTH %.0fC %.1fmV\n", e, 1065 * .134112 * 0.98, t, v * 1000.0);
   p180 = Minimum(1370, fan_power / 396, v, t);
   printf("Best efficiency %4.1fJ/TH %3.0fTH %.0fC %.1fmV\n", e, 1370 * .134112 * 0.98, t, v * 1000.0);
   }

float curvetype::HitExtrapolate(float f, float _mean, float _stddev) const
   {
...
float curvetype::CurrentExtrapolate(float f, float _cdyn, float _iddq) const
   {
