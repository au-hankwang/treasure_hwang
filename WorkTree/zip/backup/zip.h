...
void unzip_byte_with_byte(reftype &ref, unsigned char byte, const array <unsigned char> *reference=NULL, bool printit=true);
void unzip_byte(reftype &ref, const array <unsigned char> *reference=NULL, bool printit=true);
void unzip_byte_buffered(reftype &ref, const array <unsigned char> *reference=NULL, bool printit=true);
...
void zip_byte_with_byte(reftype &ref, unsigned char byte, bool printit=true);
void zip_byte(reftype &ref, bool printit=true);
void zip_byte_buffered(reftype &ref, bool printit=true);
