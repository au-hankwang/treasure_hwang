...
static arraytype <objecttype> objects;
...
bool LeakCheckFreeObject(HANDLE hObject)
   ...
   if (program_exit_in_progress)
      return true;   // I can't predict whether a static object's destructor might call delete object after my arraytypetype has been destroyed
...
#define EXCEPTION( x ) case EXCEPTION_##x: return _T(#x);
   ...
   switch ( dwCode )
      ...
      EXCEPTION( arraytype_BOUNDS_EXCEEDED )
