...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, id33_0__Pin|id33_1__Pin|id33_2__Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, id33_3__Pin|io_enable_Pin|response_i_Pin|psu_enable_Pin
                          |id33_5__Pin|id33_7__Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, scv_enable_Pin|test_mode_i_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, reset_i33_Pin|enable_25mhz_Pin|thermal_trip_i33_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : id33_0__Pin id33_1__Pin id33_2__Pin */
  GPIO_InitStruct.Pin = id33_0__Pin|id33_1__Pin|id33_2__Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : id33_3__Pin io_enable_Pin response_i_Pin psu_enable_Pin
                           id33_5__Pin id33_7__Pin */
  GPIO_InitStruct.Pin = id33_3__Pin|io_enable_Pin|response_i_Pin|psu_enable_Pin
                          |id33_5__Pin|id33_7__Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : command_o_Pin */
  GPIO_InitStruct.Pin = command_o_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(command_o_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : scv_enable_Pin test_mode_i_Pin */
  GPIO_InitStruct.Pin = scv_enable_Pin|test_mode_i_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);

  /*Configure GPIO pin : thermal_trip_o33_Pin */
  GPIO_InitStruct.Pin = thermal_trip_o33_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(thermal_trip_o33_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : reset_i33_Pin enable_25mhz_Pin thermal_trip_i33_Pin */
  GPIO_InitStruct.Pin = reset_i33_Pin|enable_25mhz_Pin|thermal_trip_i33_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : test_clock_out_Pin */
  GPIO_InitStruct.Pin = test_clock_out_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(test_clock_out_GPIO_Port, &GPIO_InitStruct);
