...
public:
   ...
   float temperature, frequency, voltage, hitrate;        // frequency in Mhz
...
protected:
   ...
   void CalibrateDVM();
   void Optimize(float average_f, bool& too_hot, bool eco, int experiment); // this function takes average_f and returns the hitrate(0-1.0), doesn't adjust voltage
...
public:
   ...
   float MeasureHashRate(int period, bool &too_hot, float& avg_temp, float& max_temp, bool shortcut=false);
