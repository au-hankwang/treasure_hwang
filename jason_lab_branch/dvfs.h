...
public:
   ...
   float temperature, frequency, voltage, hitrate, missionhitrate, phase2;        // frequency in Mhz

   float frequency2, hitrate2, missionhitrate2;
   unsigned partition[8];  // engine mask for the slow engine(ie copy this to ENGINE_MASK and you will have the fast partition)
