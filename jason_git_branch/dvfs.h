...
public:
   ...
   float temperature, frequency, voltage, hitrate, missionhitrate;        // frequency in Mhz
...
public:
   ...
   float MeasureHashRate(int period, bool &too_hot, float& avg_temp, float& max_temp, int experiment=0, bool no_reset=true);
